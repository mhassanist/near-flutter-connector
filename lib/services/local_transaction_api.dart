...
class LocalTransactionAPI {
  ...
  static Uint8List _serializeTransferTransaction(MyTransaction myTransaction) {
    final transferTransaction = TransferTransaction(
        transferActions: [
          tx_action.TransferAction(
              eNum: 3,
    ...
    final serializedStruct = transferTransaction.toBorsh();
  ...
  static Uint8List _serializeFunctionCallTransaction(
    ...
    final functionCallTransaction = FunctionCallTransaction(
        functionCallActions: [
          tx_action.FunctionCallAction(
              eNum: 2,
              functionCall: tx_action.FunctionCall(
        ...
        receiverId: myTransaction.contractId as String,
        signerId: myTransaction.sender as String);
    final serializedStruct = functionCallTransaction.toBorsh();
    return serializedStruct;
  }
}
